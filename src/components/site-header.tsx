...
export function SiteHeader({ toggleSidebar, isSidebarExpanded }: SiteHeaderProps) {
  ...
  // Get header gradient based on palette
  const getHeaderGradient = () => {
    const palette = settings?.colorPalette || 'blue-orange';

    const gradientMap = {
      'blue-orange': 'bg-gradient-to-r from-blue-50/50 via-purple-50/50 to-orange-50/50',
      'purple-pink': 'bg-gradient-to-r from-purple-50/50 via-pink-50/50 to-fuchsia-50/50',
      'green-teal': 'bg-gradient-to-r from-green-50/50 via-teal-50/50 to-emerald-50/50',
      'red-yellow': 'bg-gradient-to-r from-red-50/50 via-orange-50/50 to-yellow-50/50',
      'indigo-cyan': 'bg-gradient-to-r from-indigo-50/50 via-cyan-50/50 to-sky-50/50',
      'slate-amber': 'bg-gradient-to-r from-slate-50/50 via-stone-50/50 to-amber-50/50'
    };
  ...
  return (
    <header className={`sticky top-0 z-30 flex h-14 items-center gap-4 border-b px-4 sm:static sm:h-auto sm:border-0 sm:px-6 ${getHeaderGradient()}`}>
      <Sheet>

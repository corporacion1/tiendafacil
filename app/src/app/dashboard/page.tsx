...
export default function Dashboard() {
  ...
  const [products, setProductsState] = useState(mockProducts.map(p => ({...p, storeId: 'local', createdAt: new Date().toISOString()})));
                  ...
                  <div className="p-1">
                    ...
                    <ResponsiveContainer width="100%" height={350}>
                      <LineChart data={chartData}>
                          ...
                          />
                          <Legend />
                          <Line type="monotone" dataKey="sales" name="Ventas" stroke="var(--color-chart-1)" strokeWidth={2} />
                          <Line type="monotone" dataKey="profit" name="Utilidad Bruta" stroke="var(--color-chart-3)" strokeWidth={2} />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                </CarouselItem>
                   ...
                   <div className="p-1">
                    ...
                    <ResponsiveContainer width="100%" height={350}>
                      <BarChart data={chartData}>
                        ...
                        />
                        <Legend />
                        <Bar dataKey="unitsPurchased" name="Entradas (Compra)" fill="var(--color-chart-3)" radius={[4, 4, 0, 0]} />
                        <Bar dataKey="unitsSold" name="Salidas (Venta)" fill="var(--color-chart-2)" radius={[4, 4, 0, 0]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </CarouselItem>
